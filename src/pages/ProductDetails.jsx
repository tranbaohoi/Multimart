...
const ProductDetails = () => {
    ...
    const submitHandler = (e) => {
        ...
        toast.success("Reviewd submitted")
    }
                                            ...
                                            <div className='review__form'>
                                                ...
                                                <form action="" onSubmit={submitHandler}>
                                                    ...
                                                    <div className='form__group d-flex align-items-center gap-5 rating__group'>
                                                        ...
                                                        <motion.span whileTap={{ scale: 1.2 }} onClick={() => setRating(1)}>2<i className='ri-star-s-fill'></i></motion.span>
                                                        <motion.span whileTap={{ scale: 1.2 }} onClick={() => setRating(1)}>3<i className='ri-star-s-fill'></i></motion.span>
                                                        <motion.span whileTap={{ scale: 1.2 }} onClick={() => setRating(1)}>4<i className='ri-star-s-fill'></i></motion.span>
                                                        <motion.span whileTap={{ scale: 1.2 }} onClick={() => setRating(1)}>5<i className='ri-star-s-fill'></i></motion.span>
                                                    </div>
